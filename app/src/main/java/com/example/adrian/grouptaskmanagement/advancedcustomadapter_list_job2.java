...
public class advancedcustomadapter_list_job2 extends ArrayAdapter<String> {
    public advancedcustomadapter_list_job2(@NonNull Context context, String[] resource) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Worker_task.setText(singletask);
