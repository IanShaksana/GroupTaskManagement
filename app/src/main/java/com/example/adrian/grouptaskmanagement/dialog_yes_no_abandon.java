...
public class dialog_yes_no_abandon extends AppCompatDialogFragment {
    private dialog_yes_no_abandon.dialogListener_yes_no_abandon listener;
    ...
    public void onAttach(Context context) {
        ...
        listener = (dialog_yes_no_abandon.dialogListener_yes_no_abandon)getTargetFragment();
    }
