...
public class Frag_Create_Task extends Fragment implements DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
    @Nullable
    EditText taskname;
    EditText taskdesc;
    TextView taskdiff;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        crt_job_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.fragmentBottom, new Frag_Create_Task()).commit();
