...
public class advancedcustomadapter_list_job extends ArrayAdapter<String> {
    public advancedcustomadapter_list_job(@NonNull Context context, String[] resource) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        LayoutInflater inflater = LayoutInflater.from(getContext());
        View cusView = inflater.inflate(R.layout.job_detail, parent, false);
        ...
        Worker_name = (TextView) cusView.findViewById(R.id.job_name);
        Worker_task = (TextView) cusView.findViewById(R.id.id_name);
        ...
        Worker_task.setText(splitted_task[1]);
