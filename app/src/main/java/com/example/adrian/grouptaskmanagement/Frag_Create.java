...
public class Frag_Create extends Fragment implements dialog_worker_slot.dialogListener_worker,DatePickerDialog.OnDateSetListener,TimePickerDialog.OnTimeSetListener {
    @Nullable
