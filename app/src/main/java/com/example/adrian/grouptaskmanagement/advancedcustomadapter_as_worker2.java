...
public class advancedcustomadapter_as_worker2 extends ArrayAdapter<String> {
    public advancedcustomadapter_as_worker2(@NonNull Context context, String[] resource) {
